...
export const OrganizationSchema = {
  ...
  url: 'https://blueteeth-clinical-reward-ecosystem.vercel.app',
  logo: 'https://blueteeth-clinical-reward-ecosystem.vercel.app/logo.png',
  description:
...
export const WebsiteSchema = {
  ...
  potentialAction: {
    ...
    target: {
      '@type': 'EntryPoint',
      urlTemplate: 'https://blueteeth-clinical-reward-ecosystem.vercel.app/?q={search_term_string}',
    },
